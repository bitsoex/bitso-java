...
<!-- Source: bitsoex/ai-code-instructions → global/skills/mcp-configuration/references/vscode-discovery.md -->
<!-- To modify, edit the source file and run the distribution workflow -->

# VS Code MCP Discovery

Manage VS Code's MCP discovery feature to prevent configuration conflicts.
