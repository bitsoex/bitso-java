...
Provides workflows for CodeRabbit code reviews: local CLI usage, PR thread processing, and commit attribution.
...
| Script | Purpose |
|--------|---------|
| `scripts/run-local-review.js` | Run CodeRabbit CLI and save findings |
| `scripts/export-comments.js` | Export PR comments to local JSON |
| `scripts/reply-to-threads.js` | Batch reply to threads after fixes |
