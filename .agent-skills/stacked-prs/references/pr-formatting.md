...
|-----------|-------------|---------|
| `🤖` | AI-assisted work indicator | Required for all AI work |
| `[TYPE_EMOJI]` | Work type emoji | 📦 🛡️ ✅ 🧪 ♻️ ✨ 🧹 |
...
| Emoji | Type | Example |
|-------|------|---------|
| 📦 | Dependencies/Package | `🤖 📦 [EN-113] chore(deps): update pnpm (PR 1/4)` |
| ♻️ | Refactoring | `🤖 ♻️ [EN-113] refactor: convert scripts (PR 2/4)` |
| ✨ | New Feature | `🤖 ✨ [EN-113] feat: add skills (PR 3/4)` |
| 🧹 | Cleanup/Chore | `🤖 🧹 [EN-113] chore: cleanup (PR 4/4)` |
| 🛡️ | Security | `🤖 🛡️ [SEC-45] fix(security): patch CVE (PR 1/2)` |
...
```text
🤖 ♻️ [EN-113] refactor: convert shell scripts to JavaScript (PR 2/4)
```
