...
|-----------|---------|----------------|
| `test-augmentation` | Validates test coverage | `.agent-skills/test-augmentation/` |
| `doc-sync` | Validates documentation | `.agent-skills/doc-sync/` |
| `coding-standards` | Enforces code style | `.agent-skills/coding-standards/` |
| `security-review` | Checks for vulnerabilities | `.agent-skills/security-review/` |
...
For hook implementation patterns, see the `agent-hooks` skill in `.agent-skills/agent-hooks/`.
