...
- [Why Dependency Graph Matters](#why-dependency-graph-matters) (L15-L31)
- [Setup Dependency Graph Plugin](#setup-dependency-graph-plugin) (L32-L52)
- [Generate Dependency Graph](#generate-dependency-graph) (L53-L62)
- [Verify Fix](#verify-fix) (L63-L84)
- [Find Which Configuration Brings Old Version](#find-which-configuration-brings-old-version) (L85-L94)
- [Common Issues](#common-issues) (L95-L132)
...
<!-- Source: bitsoex/ai-code-instructions → java/skills/dependabot-security/references/dependency-graph.md -->
