...
- [Processing Order](#processing-order) (L15-L23)
- [Workflow](#workflow) (L24-L30)
- [Determine Current Severity](#determine-current-severity) (L31-L54)
- [Get Alerts for Target Severity](#get-alerts-for-target-severity) (L55-L67)
- [Branch Naming](#branch-naming) (L68-L76)
- [After Fixing Current Severity](#after-fixing-current-severity) (L77-L86)
...
<!-- Source: bitsoex/ai-code-instructions → java/skills/dependabot-security/references/severity-processing.md -->
