...
- [Service Implementation](#service-implementation) (L98-L119)
- [Client Configuration](#client-configuration) (L121-L145)
- [References](#references) (L147-L153)
- [Related Rules](#related-rules) (L155-L158)
- [Related Skills](#related-skills) (L160-L165)

### Available Resources

**📚 references/** - Detailed documentation
- [contracts](references/contracts.md) - Protobuf contract guidelines and versioning
- [resilience](references/resilience.md) - Retry, bulkhead, circuit breaker patterns
- [linting](references/linting.md) - Buf linting and custom rules
