...
- [When to use this skill](#when-to-use-this-skill) (L24-L30)
- [Tech Stack](#tech-stack) (L53-L65)
- [Project Organization](#project-organization) (L67-L81)
- [Build Verification](#build-verification) (L83-L95)
- [References](#references) (L97-L103)
- [Related Rules](#related-rules) (L105-L109)
- [Related Skills](#related-skills) (L111-L117)

### Available Resources

**📚 references/** - Detailed documentation
- [services](references/services.md) - Tech stack, project structure, MapStruct
- [code-review](references/code-review.md) - Code review standards
- [build-verification](references/build-verification.md) - Build verification commands
