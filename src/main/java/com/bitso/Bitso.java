...
public class Bitso {
    ...
    public BitsoOrder getOrderBook(BitsoBook book) {
    ...
    public String placeOrder(BitsoBook book, Order.SIDE side, Order.TYPE type, BigDecimal major,
        ...
        if ((type.compareTo(Order.TYPE.LIMIT) == 0) && (price != null)) {
