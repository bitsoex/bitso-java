...
public class Bitso {
	...
	private static final String BITSO_V2_BASE_URL_PRODUCTION = "https://api.bitso.com/v2/";
	private static final String BITSO_V2_BASE_URL_DEV = "https://dev.bitso.com/api/v2/";
	...
	public Bitso(String key, String secret, String clientId, int retries, boolean log, boolean production) {
		...
		this.log = log;
		this.baseUrlV2 = production ? BITSO_V2_BASE_URL_PRODUCTION : BITSO_V2_BASE_URL_DEV;
	...
	public BitsoTicker getTicker(BitsoBook book) {
		String json = sendGet(baseUrlV2 + "ticker?book=" + book.toString());
	...
	public OrderBook getOrderBook(BitsoBook book) {
		String json = sendGet(baseUrlV2 + "order_book?book=" + book.toString());
		JSONObject o = Helpers.parseJson(json);
		if (o == null) {
	...
	public BitsoTransactions getTransactions(BitsoBook book) {
		String json = sendGet(baseUrlV2 + "transactions?book=" + book.toString());
	...
	public BitsoBalance getBalance() {
		String json = sendBitsoPost(baseUrlV2 + "balance");
		JSONObject o = Helpers.parseJson(json);
		if (o == null || o.has("error")) {
	...
	public BitsoUserTransactions getUserTransactions(int offset, int limit, SORT_ORDER sortOrder, BitsoBook book) {
		...
		String json = sendBitsoPost(baseUrlV2 + "user_transactions", body);
		JSONArray a = Helpers.parseJsonArray(json);
		if (a == null) {
	...
	public BitsoOpenOrders getOpenOrders(BitsoBook book) {
		HashMap<String, Object> body = new HashMap<String, Object>();
		body.put("book", book.toString());
		String json = sendBitsoPost(baseUrlV2 + "open_orders", body);
		JSONArray a = Helpers.parseJsonArray(json);
		if (a == null) {
	...
	public BitsoLookupOrders lookupOrder(String orderId) {
		HashMap<String, Object> body = new HashMap<String, Object>();
		body.put("id", orderId);
		String json = sendBitsoPost(baseUrlV2 + "lookup_order", body);
		JSONArray a = Helpers.parseJsonArray(json);
		if (a == null) {
	...
	public boolean cancelOrder(String orderId) {
		...
		HashMap<String, Object> body = new HashMap<String, Object>();
		body.put("id", orderId);
		String ret = sendBitsoPost(baseUrlV2 + "cancel_order", body);
	...
	public BookOrder placeBuyLimitOrder(BigDecimal price, BigDecimal amount, BitsoBook book) {
		...
		String json = sendBitsoPost(baseUrlV2 + "buy", body);
	...
	public BookOrder placeSellLimitOrder(BigDecimal price, BigDecimal amount, BitsoBook book) {
		...
		String json = sendBitsoPost(baseUrlV2 + "sell", body);
		return processBookOrderJSON(json);
	}
	...
	public String getDepositAddress() {
		return quoteEliminator(sendBitsoPost(baseUrlV2 + "bitcoin_deposit_address"));
	}
	...
	public boolean withdrawBTC(String address, BigDecimal amount) {
		...
		String ret = sendBitsoPost(baseUrlV2 + "bitcoin_withdrawal", body);
	...
	public boolean speiWithdrawal(BigDecimal amount, String recipientGivenName, String recipientFamilyName,
		...
		String ret = sendBitsoPost(baseUrlV2 + "spei_withdrawal", body);
		if (ret != null && ret.equals("\"ok\"")) {
	 ...
	 *             instead.
	 */
	public boolean withdrawMXN(BigDecimal amount, String recipientGivenName, String recipientFamilyName, String clabe,
			String notesRef, String numericRef) {
	...
	public BitsoTransferQuote requestQuote(BigDecimal btcAmount, BigDecimal amount, String currency, boolean full) {
		...
		body.put("full", full);
		String ret = sendBitsoPost(baseUrlV2 + "transfer_quote", body);
	...
	public BitsoTransfer createTransfer(BigDecimal btcAmount, BigDecimal amount, String currency, BigDecimal rate,
			String paymentOutlet, HashMap<String, Object> requiredFields) {
		if (btcAmount != null && amount != null) {
			logError("btcAmount and amount are mutually exclusive!");
			return null;
		}
		...
		String ret = sendBitsoPost(baseUrlV2 + "transfer_create", body);
		JSONObject o = Helpers.parseJson(ret);
		if (o == null || o.has("error")) {
			logError("Unable to request quote: " + ret);
			return null;
	...
	public BitsoTransfer getTransferStatus(String transferId) {
		String ret = sendGet(baseUrlV2 + "transfer/" + transferId);
		JSONObject o = Helpers.parseJson(ret);
		if (o == null || o.has("error")) {
	...
	private String sendBitsoPost(String url, HashMap<String, Object> bodyExtras) {
		...
		try {
			return client.sendPost(/* url"https://bitso.com/api/v3/ledger */"https://dev.bitso.com/api/v3/ledger",
