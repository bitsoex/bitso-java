---
applyTo: "gradle/libs.versions.toml,build.gradle,gradle/dependency-graph-init.gradle"
...
- **Vulnerability Golden Paths**: `java/rules/java-vulnerability-golden-paths.md` - **Check first** - Proven fix patterns for common vulnerabilities
...
|---------|-------------|--------------|
| `org.lz4:lz4-java` | CVE-2025-66566, CVE-2025-12183 | **GAV substitution** to `at.yawk.lz4:lz4-java:1.10.1` |
| `commons-lang3` | CVE-2025-48924 | Update version catalog + substitution |
...
| `okhttp3` | CVE-2023-0833 | Version catalog + substitution |
| `ion-java` | CVE-2024-21634 | Version catalog + force |
| `spring-core` | CVE-2025-41249 | Update Spring Boot BOM |

**Note**: For discontinued packages like `org.lz4:lz4-java`, see `java/rules/java-vulnerability-golden-paths.md` for GAV substitution patterns.

## Related

- **Vulnerability Golden Paths**: `java/rules/java-vulnerability-golden-paths.md` - Proven fix patterns
