...
Using SonarQube MCP (v1.10+) for Java code quality analysis, coverage checking, and security review.

## Skill Location

| Skill | Coverage |
|-------|----------|
| [fix-sonarqube](.claude/skills/fix-sonarqube/SKILL.md) | MCP tools, common rules, coverage, hotspots |
