...
- You should always configure and execute linters when creating protobufs, check [protobuf-linting](.cursor/rules/java-protobuf-linting/java-protobuf-linting.mdc) for details on the linting process
