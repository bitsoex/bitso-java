---
applyTo: "**/*Lock*.java,**/*Scheduler*.java,**/application*.yml"
...
| Skill | Coverage |
|-------|----------|
| `.claude/skills/distributed-locking/` | Migration workflow, lock patterns, Redis integration |
...
```
.claude/skills/distributed-locking/SKILL.md
```
