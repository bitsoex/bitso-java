...
alwaysApply: false
globs: bitso-services/**/*.java,bitso-libs/**/*.java
tags:
  - java
---
...
<!-- https://bitsomx.atlassian.net/wiki/spaces/BAB/pages/4485840987/RFC-37+Service+documentation+standardization -->
...
- `decisions/` - Architecture Decision Records (ADRs) documenting important decisions
...
- `<service-name>/getting-started/` - Quick tutorials to get started with the service
- `<service-name>/<feature>/` - Documentation for specific features/components
...
Include appropriate metadata in markdown files to ensure proper mirroring:
