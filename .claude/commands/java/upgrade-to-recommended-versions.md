...
| **bitso-commons-redis** | **4.2.1** | If using Redis (Jedis 4) |
...
**Fix**: Force JUnit 5.14.1 alignment. See `java/golden-paths/junit-version-alignment.md` for detailed patterns.
...
**Cause**: Jedis 4 API changes in Spring Boot 3.5.x.
