...
- [What is this?](#what-is-this) (L14-L17)
- [Why Common Changelog doesn't include Unreleased](#why-common-changelog-doesnt-include-unreleased) (L18-L25)
- [Why we use it anyway](#why-we-use-it-anyway) (L26-L55)
- [How to use Unreleased](#how-to-use-unreleased) (L56-L103)
- [Future migration](#future-migration) (L104-L112)
- [Validation](#validation) (L113-L119)
- [Related](#related) (L120-L123)
