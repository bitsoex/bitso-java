...
- [Create Draft PR with Auto-Assignment](#create-draft-pr-with-auto-assignment) (L29-L58)
- [One-Liner for Create and Assign](#one-liner-for-create-and-assign) (L59-L66)
- [PR Title Format](#pr-title-format) (L67-L77)
- [PR Body Template](#pr-body-template) (L78-L103)
- [Mark Ready and Add Reviewers](#mark-ready-and-add-reviewers) (L104-L113)
- [PR Status & CI Checks](#pr-status-ci-checks) (L114-L122)
