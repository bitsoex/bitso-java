...
- [Strategy 1: Update BOM/Platform Version (PREFERRED)](#strategy-1-update-bomplatform-version-preferred) (L19-L32)
- [Strategy 2: Update Direct Dependency in Version Catalog](#strategy-2-update-direct-dependency-in-version-catalog) (L33-L45)
- [Strategy 3: Dependency Substitution (For Transitive Not in BOM)](#strategy-3-dependency-substitution-for-transitive-not-in-bom) (L46-L70)
- [Strategy 3b: GAV Substitution (For Discontinued Packages)](#strategy-3b-gav-substitution-for-discontinued-packages) (L71-L98)
- [Strategy 4: Dependency Constraints](#strategy-4-dependency-constraints) (L99-L116)
- [Strategy 5: Force Rules (Use With Caution)](#strategy-5-force-rules-use-with-caution) (L117-L133)
- [Strategy 6: Exclude and Add (Last Resort)](#strategy-6-exclude-and-add-last-resort) (L134-L147)
- [Strategy Comparison](#strategy-comparison) (L148-L158)
- [Verify Fix with Lockfiles](#verify-fix-with-lockfiles) (L159-L208)
- [Document Your Strategy Choice](#document-your-strategy-choice) (L209-L221)
