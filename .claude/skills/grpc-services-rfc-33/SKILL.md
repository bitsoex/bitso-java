...
compatibility: Java projects using gRPC with Spring Boot; requires Buf CLI and bitso-grpc-linter
metadata:
  version: "1.0.0"
  technology: java
...
See [references/installation.md](references/installation.md) for details, Docker alternative, and troubleshooting.
...
| [references/installation.md](references/installation.md) | Buf CLI and gRPC Linter installation (Homebrew, Docker, cloud) |
...
- [java-grpc-services](.cursor/rules/java-grpc-services/java-grpc-services.mdc) - gRPC service standards
- [java-grpc-resilience](.cursor/rules/java-grpc-resilience/java-grpc-resilience.mdc) - Resilience configuration
...
| [java-testing](.claude/skills/java-testing/SKILL.md) | Testing gRPC services |
<!-- AUTO-GENERATED FILE - DO NOT EDIT DIRECTLY -->
<!-- Source: bitsoex/ai-code-instructions → java/skills/grpc-services-rfc-33/SKILL.md -->
