...
- [Overview](#overview) (L14-L22)
- [Migration Scenarios](#migration-scenarios) (L23-L32)
- [Keep a Changelog to Common Changelog](#keep-a-changelog-to-common-changelog) (L33-L130)
- [GitHub Releases to Changelog](#github-releases-to-changelog) (L131-L174)
- [Git Tags Only](#git-tags-only) (L175-L205)
- [Fresh Start (No History)](#fresh-start-no-history) (L206-L246)
- [Rollout Strategy](#rollout-strategy) (L247-L283)
...
<!-- Source: bitsoex/ai-code-instructions → global/skills/changelog/references/migration-guide.md -->
