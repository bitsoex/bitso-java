...
- [Service Naming](#service-naming) (L16-L20)
- [Message Design](#message-design) (L21-L27)
- [Documentation Requirements](#documentation-requirements) (L28-L54)
- [Versioning](#versioning) (L55-L62)
- [Contract Exposure](#contract-exposure) (L63-L86)
- [Code Generation](#code-generation) (L87-L134)
- [Server Implementation](#server-implementation) (L135-L168)
- [Server Configuration](#server-configuration) (L169-L175)
- [Client Implementation](#client-implementation) (L176-L181)
...
<!-- Source: bitsoex/ai-code-instructions → java/skills/grpc-standards/references/contracts.md -->
