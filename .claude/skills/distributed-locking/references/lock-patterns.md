...
- [Basic Patterns](#basic-patterns) (L21-L53)
- [Lock Key Naming](#lock-key-naming) (L54-L63)
- [PostgreSQL Advisory Locks](#postgresql-advisory-locks) (L64-L91)
- [Lock Acquisition Behavior](#lock-acquisition-behavior) (L92-L121)
- [Error Handling](#error-handling) (L122-L164)
- [Anti-Patterns](#anti-patterns) (L165-L199)
- [Related](#related) (L200-L204)
...
<!-- Source: bitsoex/ai-code-instructions → java/skills/distributed-locking/references/lock-patterns.md -->
