...
- [When to Use Redis Locking](#when-to-use-redis-locking) (L21-L28)
- [Setup](#setup) (L29-L68)
- [Usage Patterns](#usage-patterns) (L69-L125)
- [Lock Configuration](#lock-configuration) (L126-L157)
- [Testing](#testing) (L158-L191)
- [Migrating from Redis to PostgreSQL](#migrating-from-redis-to-postgresql) (L192-L217)
- [Related](#related) (L218-L222)
...
<!-- Source: bitsoex/ai-code-instructions → java/skills/distributed-locking/references/redis-integration.md -->
