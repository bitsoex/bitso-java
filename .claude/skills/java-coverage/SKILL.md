...
- [Checking Coverage via SonarQube MCP](#checking-coverage-via-sonarqube-mcp)
...
- [coverage via mcp](.claude/skills/fix-sonarqube/references/coverage-via-mcp.md)
...
| `get_component_measures` | Project/module-level coverage metric |
| `get_project_quality_gate_status` | Check if coverage gate passes |
