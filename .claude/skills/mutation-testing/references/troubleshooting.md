...
- [Tests Fail During Mutation Testing](#tests-fail-during-mutation-testing) (L16-L27)
- [Integration Tests Timeout](#integration-tests-timeout) (L28-L41)
- [Out of Memory Errors](#out-of-memory-errors) (L42-L57)
- [Mutation Testing Takes Too Long](#mutation-testing-takes-too-long) (L58-L68)
- [No Mutations Generated](#no-mutations-generated) (L69-L78)
- [JUnit 5 Tests Not Detected](#junit-5-tests-not-detected) (L79-L90)
- [Spock Tests Not Detected](#spock-tests-not-detected) (L91-L100)
- ["No tests executed" Error](#no-tests-executed-error) (L101-L114)
- [Surviving Mutants on Obvious Code](#surviving-mutants-on-obvious-code) (L115-L131)
