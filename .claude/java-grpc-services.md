...
- You should always configure and execute linters when creating protobufs, check [protobuf-linting.mdc](mdc:.cursor/rules/protobuf-linting.mdc) for details on the linting process
