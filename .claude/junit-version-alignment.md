...
**Applies to:** build.gradle, gradle/libs.versions.toml
...
dependencies {
    // Test dependencies - manually configured for JUnit 5.14.1
...
// Force JUnit 5.14.1 across all configurations
configurations.all {
    resolutionStrategy.eachDependency { details ->
        if (details.requested.group == 'org.junit.jupiter') {
            details.useVersion '5.14.1'
...
dependencies {
    // Test dependencies - manually configured
    testImplementation platform('org.junit:junit-bom:5.14.1')
    testImplementation 'org.junit.jupiter:junit-jupiter'
    testImplementation libs.spock.core
}
...
1. Add explicit platform import:
