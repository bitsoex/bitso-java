...
node global/skills/coderabbit-interactions/scripts/export-comments.js --pr 69
...
# 10. Reply to threads
node global/skills/coderabbit-interactions/scripts/reply-to-threads.js --file .tmp/coderabbit-pr-69-*.json
...
```bash
# 1. Export and review
node global/skills/coderabbit-interactions/scripts/export-comments.js --pr 42
...
# 5. Push and reply
git push
node global/skills/coderabbit-interactions/scripts/reply-to-threads.js --file .tmp/coderabbit-pr-42-*.json
```
...
| Export PR comments | `node global/skills/coderabbit-interactions/scripts/export-comments.js --pr N` |
