...
Even with hooks, a rule provides additional guidance. Create `.cursor/rules/quality-gate.mdc`:
...
Create `.cursor/commands/quality-check.md`:
...
- Full skill: `.skills/quality-gateway/`
...
Create `.cursor/commands/add-tests.md`:
...
Uses the `test-augmentation` skill to:
...
- Full skill: `.skills/test-augmentation/`
- Quality check: `/quality-check`
```

### /sync-docs

Create `.cursor/commands/sync-docs.md`:
...
mkdir -p .cursor/hooks .cursor/rules .cursor/commands
...
# Create quality-gate.mdc, quality-check.md, add-tests.md, sync-docs.md
...
# Create quality-check.md, add-tests.md, sync-docs.md
```
